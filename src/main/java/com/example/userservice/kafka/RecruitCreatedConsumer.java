...
import com.example.userservice.repository.UserCompanySubscriptionRepository;
...
public class RecruitCreatedConsumer {
    ...
    private final UserCompanySubscriptionRepository companySubscriptionRepository;
    ...
    public void consume(RecruitCreatedMessage message) {
        ...
        List<UserRecruitSubscription> subscribers = companySubscriptionRepository.findByCompanyId(companyId);
